...
/* CPU exception stubs (defined in boot/isr.asm) */
...
/* Hardware IRQ stubs (defined in boot/isr.asm) */
...
/* C-side handlers called from isr.asm common stubs */
void isr_handler(registers_t *regs);
void irq_handler(registers_t *regs);

/* Called from idt_init() to install all gates + remap PIC */
void isr_init(void);
